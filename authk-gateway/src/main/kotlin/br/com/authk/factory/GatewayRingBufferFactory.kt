...
class GatewayRingBufferFactory : RingBufferFactory {
    ...
    companion object {
        ...
        init{
            EVENT_HANDLERS_BY_RING_ID[RingID.INBOUND_TO_PRE_BUSINESS] = GatewayEventHandlerFactory()
                .preBusinessLogicHandlers()
            EVENT_HANDLERS_BY_RING_ID[RingID.PRE_BUSINESS_TO_BUSINESS] = GatewayEventHandlerFactory()
                .businessHandlers()
            EVENT_HANDLERS_BY_RING_ID[RingID.BUSINESS_TO_OUTBOUND] = GatewayEventHandlerFactory()
    ...
    override fun lazyGetRingBuffer(ringID : RingID) : RingBuffer<ContextEvent>?{
        ...
        if(ringBuffer == null) {
            ...
            val disruptor: Disruptor<ContextEvent> =
                GatewayRingBufferFactory().createDisruptor(handlers)
